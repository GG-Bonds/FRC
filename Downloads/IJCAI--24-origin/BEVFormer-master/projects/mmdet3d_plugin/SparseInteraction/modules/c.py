...
class SpatialCrossAttention_Radar_Sparse(BaseModule):
    ...
    def __init__(self,
        ...
        super(SpatialCrossAttention_Radar_Sparse, self).__init__(init_cfg)
